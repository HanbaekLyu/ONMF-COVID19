...
def main_train_joint():
    ...
    foldername = 'test2'  ## for saving files
    ...
    reconstructor = ONMF_timeseries_reconstructor(path=path_COVID_tracking_proj,
                                                   ...
                                                   ONMF_sub_iterations=2,  # number of i.i.d. subsampling for each iteration of ONTF
    ...
    if if_ONMF_timeseris_predictor_historic:
        ...
        A_full_predictions_trials = reconstructor.ONMF_timeseris_predictor_historic(mode=3,
                                                     ...
                                                     minibatch_alpha=1,
                                                     minibatch_beta=1,
                                                     num_trials=3)  # take a number of trials to generate empirical confidence interval
    ...
    if if_recons:
        ...
        A_recons, W1, At1, Bt1, H = reconstructor.ONMF_timeseris_predictor(mode=3,
                                                                           ini_dict=None,
                                                                           foldername=foldername,
                                                                           beta=4,
